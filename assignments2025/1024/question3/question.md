...
Consider the Bayesian network given in the figure below. The prerequisite here is that all of the variables are Boolean.
...
- P(X₃|X₄) for the left figure, where the order of elimination follows X₅, X₁, X₂;
- P(X₃|X₄) for the left figure, where the order of elimination follows X₂, X₁, X₅;
- P(X₃|X₄) for the right figure, where the order of elimination follows X₅, X₁, X₂;
- P(X₃|X₄) for the right figure, where the order of elimination follows X₂, X₁, X₅.